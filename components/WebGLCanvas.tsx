...
const WebGLCanvas = () => {
  ...
  useEffect(() => {
    ...
    interface WebGLContextInfo {
      ...
      support_linear_float: any;
    }

    function getWebGLContext(canvas: HTMLCanvasElement): WebGLContextInfo {
      ...
      const halfFloat: any = gl.getExtension("OES_texture_half_float");
      let support_linear_float: any = gl.getExtension(
    ...
    class GLProgram {
      ...
      constructor(vertexShader: WebGLShader, fragmentShader: WebGLShader) {
        ...
        if (!gl.getProgramParameter(this.program, gl.LINK_STATUS)) {
          throw gl.getProgramInfoLog(this.program) as string;
        }
    ...
    function compileShader(type: number, source: string): WebGLShader {
      ...
      if (!gl.getShaderParameter(shader, gl.COMPILE_STATUS))
        throw gl.getShaderInfoLog(shader) as string;
    ...
    function createFBO(
      ...
      gl.clearColor(153 / 255, 186 / 255, 241 / 255, 1.0);
    ...
    const blit = (function () {
      ...
      return function (destination: WebGLFramebuffer | null): void {
